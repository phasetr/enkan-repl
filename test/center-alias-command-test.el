...
(ert-deftest test-center-parse-alias-command-simple-alias-esc ()
  ...
  (let ((result (enkan-repl-center--parse-alias-command-pure ":er myalias :esc")))
...
(ert-deftest test-center-parse-alias-command-alias-with-text ()
  ...
  (let ((result (enkan-repl-center--parse-alias-command-pure ":er myalias hello world")))
    (should (equal (plist-get result :valid) t))
    (should (equal (plist-get result :alias) "myalias"))
...
(ert-deftest test-center-parse-alias-command-alias-ret ()
  ...
  (let ((result (enkan-repl-center--parse-alias-command-pure ":er test :ret")))
    (should (equal (plist-get result :valid) t))
    (should (equal (plist-get result :alias) "test"))
    (should (equal (plist-get result :command) :ret))
    (should (equal (plist-get result :text) nil))))

(ert-deftest test-center-parse-alias-command-no-er-prefix ()
  "Test parsing without :er prefix should fail."
  (let ((result (enkan-repl-center--parse-alias-command-pure "myalias :esc")))
...
(ert-deftest test-center-parse-alias-command-only-alias ()
  ...
  (let ((result (enkan-repl-center--parse-alias-command-pure ":er myalias")))
    (should (equal (plist-get result :valid) t))
    (should (equal (plist-get result :alias) "myalias"))
...
(ert-deftest test-center-parse-alias-command-complex-aliases ()
  ...
  (let ((result1 (enkan-repl-center--parse-alias-command-pure ":er my-complex_alias123 :esc"))
        (result2 (enkan-repl-center--parse-alias-command-pure ":er test.server :ret")))
