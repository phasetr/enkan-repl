;;; enkan-repl-buffer-matching-test.el --- Tests for buffer matching function -*- lexical-binding: t -*-

;;; Commentary:
;; Tests specifically for the actual enkan-repl--buffer-matches-directory function
...
(ert-deftest test-enkan-repl--buffer-matches-directory-actual-implementation ()
  "Test the actual implementation of enkan-repl--buffer-matches-directory."
  ;; Test non-string buffer-name
  (should (null (enkan-repl--buffer-matches-directory nil "/test")))
  (should (null (enkan-repl--buffer-matches-directory 123 "/test")))
  ...
  (should (null (enkan-repl--buffer-matches-directory "regular-buffer" "/test")))
...
(ert-deftest test-enkan-repl--buffer-matches-directory-edge-cases ()
  ...
  (should (null (enkan-repl--buffer-matches-directory "*enkan-other:/test*" "/test")))
  (should (null (enkan-repl--buffer-matches-directory "*enkanrepl:/test*" "/test"))))
