...
=enkan-repl= sends text to Claude AI and receives generated responses.
...
the interactive cheatsheet (=M-x enkan-repl-cheatsheet=) provides quick access
...
The interactive cheatsheet (=M-x enkan-repl-cheatsheet=) makes this workflow
...
6. *Access functions easily*: Use =M-x enkan-repl-cheatsheet= to browse and select functions
