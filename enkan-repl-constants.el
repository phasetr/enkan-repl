...
(defconst enkan-repl-cheat-sheet-candidates
  '(("enkan-repl-send-region" . "Send region text (from START to END) to enkan session buffer. - From enkan buffer: Send to current buffer - From other buffer without prefix: Interactive buffer selection - With numeric prefix: Send to buffer at index (1-based)  Uses unified backend with smart buffer detection.  Category: Text Sender")
    ...
    ("enkan-repl-send-escape" . "Send ESC key to enkan session buffer. - From enkan buffer: Send to current buffer - From other buffer without prefix: Interactive buffer selection - With numeric prefix: Send to buffer at index (1-based)  Uses unified backend with smart buffer detection.  Category: Text Sender")
    ...
    ("enkan-repl-setup" . "Set up window layout based on context. - Standard input file: basic window layout with project input file on left and eat session on right - Center file: auto start eat sessions using project configuration  Category: Session Controller")
    ...
    ("enkan-repl-open-project-directory" . "Open project directory in dired from current project.  Category: Center File Multi-buffer Access")
    ...
    ("enkan-repl-magit" . "Open magit for selected project from active sessions only.  Category: Center File Operations")
