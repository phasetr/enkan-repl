...
;; This script generates precompiled constants for enkan-repl cheatsheet
...
(defun generate-cheatsheet-constants ()
  ...
  (let* ((enkan-repl-file (expand-file-name "enkan-repl.el"))
    ...
    (with-temp-file output-file
      ...
      (insert "(defconst enkan-repl-cheatsheet-candidates\n")
      (insert "  '(")
      (let ((first t))
      ...
      ;; Generate metadata
      (insert (format "(defconst enkan-repl-cheatsheet-function-count\n"))
      (insert (format "  %d\n" (length candidates)))
